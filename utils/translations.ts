...
export const translations = {
  en: {
    ...
    clone: '(Clone)',
    sourceFrom: 'Source from {type}',
    chatMessage: 'Chat Message',
    clearAllInsights: 'Clear all insights',
    clearInsightsConfirmation: 'Are you sure you want to clear all generated insights for this session?',
    bold: 'Bold',
    italic: 'Italic',
    underline: 'Underline',
    ...
    // FIX: Added missing translation keys to prevent type errors and render correct UI text.
    instructions: "Instructions",
    fileInstructionP1: 'The file <strong>{fileName}</strong> has been prepared for NotebookLM.',
    fileInstructionP2: "To analyze it, follow these steps:",
    fileInstructionL1: 'Open <strong>Google NotebookLM</strong> in a new tab.',
    fileInstructionL2: 'Create a <strong>new notebook</strong> or open an existing one.',
    fileInstructionL3: 'Add the downloaded file as a new <strong>Source</strong>.',
    fileInstructionNote: 'Note: This is a one-time export. Changes made in VoiceInk after this will not be reflected.',
    continue: "Continue",
    view: "View",
    rename: "Rename",
    ...
    supportedFileTypes: "Supported: Audio files, .txt",
    enterURL: "Enter any URL",
    add: "Add",
    sourceTypeTranscription: "Transcription",
    sourceTypeAudio: "Audio File",
    sourceTypeFile: "Text File",
    sourceTypeUrl: "Web Page",
  },
  ru: {
    // ... (existing Russian keys)
    selectAll: 'Выбрать все',
    createSource: 'Создать источник',
    clone: '(Копия)',
    sourceFrom: 'Источник из {type}',
    chatMessage: 'Сообщение чата',
    clearAllInsights: 'Очистить всю аналитику',
    clearInsightsConfirmation: 'Вы уверены, что хотите очистить все сгенерированные данные для этой сессии?',
    bold: 'Жирный',
    italic: 'Курсив',
    ...
    fileInstructionP1: "Файл <strong>{fileName}</strong> был подготовлен для NotebookLM.",
    fileInstructionP2: "Чтобы проанализировать его, следуйте этим шагам:",
    fileInstructionL1: 'Откройте <strong>Google NotebookLM</strong> в новой вкладке.',
    fileInstructionL2: 'Создайте <strong>новый блокнот</strong> или откройте существующий.',
    fileInstructionL3: 'Добавьте скачанный файл как новый <strong>Источник (Source)</strong>.',
    fileInstructionNote: 'Примечание: это разовый экспорт. Изменения, внесенные в VoiceInk после этого, не будут отражены.',
    continue: "Продолжить",
    view: "Просмотр",
    ...
    supportedFileTypes: "Поддерживаются: Аудио файлы, .txt",
    enterURL: "Введите любой URL",
    add: "Добавить",
    sourceTypeTranscription: "Транскрипция",
    sourceTypeAudio: "Аудиофайл",
    sourceTypeFile: "Текстовый файл",
    sourceTypeUrl: "Веб-страница",
  },
  es: { /* ... */ },
  fr: { /* ... */ },
  de: { /* ... */ },
