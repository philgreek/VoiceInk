export const translations = {
  en: {
    ...
    addSourcesPrompt: 'VoiceInk will rely on these to write answers.',
    ...
    promptWizard: 'Prompt Wizard',
    savePrompt: 'Save Prompt',
    savePromptConfirmation: 'Save this prompt to your library?',
    promptName: 'Prompt Name',
    promptCategory: 'Category (optional)',
    newPrompt: 'New Prompt',
    searchPrompts: 'Search prompts...',
    noPromptsFound: 'No prompts found. Save your first one from the chat!',
    noPromptsMatchFilter: 'No prompts match your search or filter.',
    allCategories: 'All Categories',
    doubleClickToUse: 'Double-click to use',
    editPrompt: 'Edit Prompt',
    deletePrompt: 'Delete Prompt',
    deletePromptConfirmation: 'Are you sure you want to delete this prompt?',
    promptWizardTitle: 'Prompt Wizard',
    promptWizardDescription: 'Chat with an AI assistant to help you craft the perfect prompt.',
    use: 'Use',
    saveToLibrary: 'Save to Library',
    askPromptWizard: 'How can I help you create a prompt?',
    prompt: 'Prompt',
    importPrompts: 'Import Prompts',
    exportPrompts: 'Export Prompts',
    discussion: 'Discussion',
    discussing: 'Discussing',
    discussTopic: 'Discuss topic',
    rateLimitError: 'You have exceeded the API rate limit. Please wait a moment and try again.',
    ...
    analysis: 'Analysis',
    speakerContribution: 'Speaker Contribution',
    totalWords: 'Total Words',
    wordCount: 'Word Count',
    noTranscriptionForAnalysis: 'No transcription data available for analysis. Start recording to see statistics.',
    diarizingConversation: 'Analyzing conversation...',
  },
  ru: {
    voiceInk: 'VoiceInk',
    ...
    addSourcesPrompt: 'VoiceInk будет опираться на них при написании ответов.',
    ...
    promptWizard: 'Мастер промптов',
    savePrompt: 'Сохранить промпт',
    savePromptConfirmation: 'Сохранить этот промпт в библиотеку?',
    promptName: 'Название промпта',
    promptCategory: 'Категория (необязательно)',
    newPrompt: 'Новый промпт',
    searchPrompts: 'Искать промпты...',
    noPromptsFound: 'Промпты не найдены. Сохраните свой первый из чата!',
    noPromptsMatchFilter: 'Нет промптов, соответствующих вашему поиску или фильтру.',
    allCategories: 'Все категории',
    doubleClickToUse: 'Дважды щелкните для использования',
    editPrompt: 'Редактировать промпт',
    deletePrompt: 'Удалить промпт',
    deletePromptConfirmation: 'Вы уверены, что хотите удалить этот промпт?',
    promptWizardTitle: 'Мастер промптов',
    promptWizardDescription: 'Пообщайтесь с AI-ассистентом, чтобы создать идеальный промпт.',
    use: 'Использовать',
    saveToLibrary: 'Сохранить в библиотеку',
    askPromptWizard: 'Как я могу помочь вам создать промпт?',
    prompt: 'Промпт',
    ...
    rateLimitError: 'Вы превысили лимит запросов к API. Пожалуйста, подождите немного и попробуйте снова.',
    ...
    analysis: 'Анализ',
    speakerContribution: 'Вклад спикеров',
    totalWords: 'Всего слов',
    wordCount: 'Кол-во слов',
    noTranscriptionForAnalysis: 'Нет данных транскрипции для анализа. Начните запись, чтобы увидеть статистику.',
    diarizingConversation: 'Анализ диалога...',
  },
  es: { /* ... */ },
  fr: { /* ... */ },
  de: { /* ... */ },
